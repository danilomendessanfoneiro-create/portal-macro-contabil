...
def extrair_dp(token_empresa, cnpj, nome, competencia):
    ...
    for chave, rota in ENDPOINTS.items():
        ...
        # Endpoint recibos precisa do tipoFolha
        if chave == "folha_recibos_totais":
            url = f"https://rest.oneflow.com.br/api{rota}?competencia={competencia}&tipoFolha=1"
        else:
        ...
        try:
            ...
            if res.status_code in [200, 201]:
                ...
                print(f"      [API] {chave} retornou status {res.status_code}")
