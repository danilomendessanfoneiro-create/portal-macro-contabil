            ...
            with st.expander(titulo):
                ...
                if "itens" in row and isinstance(row["itens"],list):
                    ...
                    for i in row["itens"]:
                        ...
                        itens.append({
                        "Produto":i.get("descricaoProduto",""),
                        "Quantidade":i.get("quantidade",0),
                        "Valor Unitário":i.get("valorUnitario",0),
                        "Total":i.get("valorTotal",0)
                        })
                    ...
                    if itens:
                        ...
                        st.dataframe(
                        df_itens.style.format({
                        "Valor Unitário":format_br,
                        "Total":format_br
                        }),
